...
import {colorLabel as colorLabel_1} from './styles'
    ...
    return (
      <div style={{textAlign: 'center'}}>
        ...
        <div style={{maxWidth: 400, margin: 'auto'}}>
          {time === 0
          ? <div> <input style={inputStyles_2} onChange={this.handleChange} value={time || "0"} type="number" /> <h5 style={colorLabel_1}>Acabou o Tempo !!!</h5></div>
        ...
        <button style={buttonStyles} onClick={this.handleRunClick}>{running ? 'Parar' : 'Reproduzir'}</button>
        <button style={buttonStyles} onClick={this.handleClearClick}>Recomeçar</button>
      </div>
    )
  }
}
